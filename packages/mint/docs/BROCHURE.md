...
- **(maintainer)** `moe-mint test` needs Docker and pulls
  `ghcr.io/zak-keown/moe/moe-container`, a ~15 GB linux/amd64
...
```bash
git clone https://github.com/zak-keown/moe.git
...
ghcr.io/zak-keown/moe/moe-container, which has not been
built yet. -->
