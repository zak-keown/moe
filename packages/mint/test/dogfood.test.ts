...
// reference snapshot (`superpowers` @ b36e082), not packages/core and not
// upstream `main`.
//
...
// drift tripwire — which is the whole point of pinning (snapshots are the
// spec, not upstream HEAD).
//
