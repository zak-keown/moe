...
export function loadNativeAssetManifest(root: InstalledPackageRoot): NativeAssetManifest {
...
export function verifyNativeAsset(root: InstalledPackageRoot, record: NativeAssetRecord): string {
