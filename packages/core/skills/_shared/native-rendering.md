...
2. **Browser companion** — the in-repo brainstorm server. Resolve
   {resource:skills/brainstorming/scripts/start-server.mjs} relative to this
...
- Rung 2 fails when `node` isn't on PATH, when the sandbox blocks port
  ...
  document: {resource:skills/using-moe/references/antigravity-tools.md},
  {resource:skills/using-moe/references/codex-tools.md},
  {resource:skills/using-moe/references/gemini-tools.md}, or
  {resource:skills/using-moe/references/opencode-tools.md}.
