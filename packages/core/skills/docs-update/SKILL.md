...
this loaded document — {resource:skills/docs-update/doc-types/readme.md},
{resource:skills/docs-update/doc-types/architecture.md},
{resource:skills/docs-update/doc-types/api.md},
{resource:skills/docs-update/doc-types/contributing.md}, or
{resource:skills/docs-update/doc-types/changelog.md} — and reads each one plus
...
4. Once every dispatched agent has staged its findings, resolve
   {resource:skills/docs-update/scripts/docs-verify-report.mjs} relative to
   this loaded document and run:

   ```bash
   node "$SKILL/docs-verify-report.mjs" \
