...
Resolve {resource:skills/finding-duplicate-functions/scripts/extract-functions.sh} relative to this loaded document, then invoke it with arguments `src/ -o catalog.json`.
...
Resolve {resource:skills/finding-duplicate-functions/scripts/prepare-category-analysis.sh} relative to this loaded document, then invoke it with arguments `categorized.json ./categories`.
...
Resolve {resource:skills/finding-duplicate-functions/scripts/generate-report.sh} relative to this loaded document, then invoke it with arguments `./duplicates ./duplicates-report.md`.
