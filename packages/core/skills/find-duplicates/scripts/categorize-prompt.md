...
1. Run extraction: resolve {resource:skills/find-duplicates/scripts/extract-functions.mjs} relative to this loaded document, then run `node "<resolved-extract-functions.mjs>" src/ -o catalog.json`
