...
[Resolve workspace: "${CLAUDE_PLUGIN_ROOT}/skills/subagent-driven-development/scripts/sdd-workspace" docs/moe/plans/feature-plan.md — no ledger inside, fresh start]
