...
- Each plan owns a workspace: at skill start, resolve
  {resource:skills/subagent-driven-development/scripts/sdd-workspace.mjs} relative
...
waves deterministically. Resolve {resource:skills/subagent-driven-development/scripts/task-set.mjs} relative to this loaded document, then invoke it as:
...
- **Task brief:** before dispatching an implementer, resolve
  {resource:skills/subagent-driven-development/scripts/task-brief.mjs} relative to
