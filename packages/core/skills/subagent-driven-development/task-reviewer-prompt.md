...
Resolve {resource:skills/subagent-driven-development/scripts/task-brief.mjs} and {resource:skills/subagent-driven-development/scripts/review-package.mjs} relative to this loaded document before filling the resource-backed placeholders below.
