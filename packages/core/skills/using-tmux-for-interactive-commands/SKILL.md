...
This skill ships `scripts/tmux-wrapper.mjs`. Declare the path once, then use it:
```bash
WRAPPER="node ${CLAUDE_PLUGIN_ROOT}/skills/using-tmux-for-interactive-commands/scripts/tmux-wrapper.mjs"
