...
Resolve {resource:skills/sdd/scripts/task-brief.mjs} and {resource:skills/sdd/scripts/review-package.mjs} relative to this loaded document before filling the resource-backed placeholders below.
