...
const GENERATED_SKILLS = [
  ...
  // Bare old names deliberately kept here: `plugins/` is generated by
  // `pnpm mint` and is NOT regenerated as part of the skill-renaming task
  // (Task 3's job), so it still ships the pre-rename directory names.
