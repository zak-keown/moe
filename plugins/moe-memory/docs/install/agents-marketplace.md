...
# Installing moe-memory on Factory Droid / Grok / Copilot (marketplace descriptor)
...
droid plugin install moe-memory@moe
```
...
copilot plugin install moe-memory@moe-memory-dev
```
