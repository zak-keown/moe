...
# Installing moe-everything on Factory Droid / Grok / Copilot (marketplace descriptor)
...
droid plugin install moe-everything@moe
```
...
copilot plugin install moe-everything@moe-everything-dev
```
