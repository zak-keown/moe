...
# Installing moe-everything on Pi
...
- `.pi/extensions/moe-everything.ts`, the Pi extension module that registers the plugin's skills directory and injects bootstrap context

## Installing

```
pi install git:gitlab.tcdevops.com/Zak/moe
```
