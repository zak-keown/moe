...
description: "Use when a question needs the TurnCommerce corpus rather than the working tree: a convention or standard, a symbol in a repo you are not editing, who calls what across repos, or a decision recorded in the memory graph. Returns a summary with re-fetchable citations, never raw blocks."
mode: subagent
---
