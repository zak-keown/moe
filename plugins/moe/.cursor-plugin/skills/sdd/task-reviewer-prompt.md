...
Resolve [skills/sdd/scripts/task-brief.mjs](scripts/task-brief.mjs) and [skills/sdd/scripts/review-package.mjs](scripts/review-package.mjs) relative to this loaded document before filling the resource-backed placeholders below.
