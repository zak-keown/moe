...
Resolve [skills/subagent-driven-development/scripts/review-package.mjs](scripts/review-package.mjs) relative to this loaded document before filling `[DIFF_FILE]` below.
...
- `[DIFF_FILE]` — the path printed by invoking the resolved `review-package.mjs`
