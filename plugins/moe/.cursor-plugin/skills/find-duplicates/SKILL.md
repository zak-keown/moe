...
Dispatch a **the configured fast model** subagent using [skills/find-duplicates/scripts/categorize-prompt.md](scripts/categorize-prompt.md), resolved relative to this loaded document.
...
For each category file in `./categories/`, dispatch a **the configured deep-reasoning model** subagent using [skills/find-duplicates/scripts/find-duplicates-prompt.md](scripts/find-duplicates-prompt.md), resolved relative to this loaded document.
...
the port bind. Use the shared ladder's sharing default.
