...
Resolve [skills/scoping-the-simplest-core/scripts/check_citations.py](scripts/check_citations.py) relative to this loaded document, then invoke it with `python3` and arguments `docs/moe/iterations/roadmap.md docs/moe/iterations/requirements/`.
...
Resolve [skills/scoping-the-simplest-core/scripts/validate_roadmap.py](scripts/validate_roadmap.py) relative to this loaded document, then invoke it with `python3` and argument `docs/moe/iterations/roadmap.md`.
