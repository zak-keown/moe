...
Use this template when dispatching auditor subagents inside the PAR wrapper. Resolve [skills/_shared/par-reviewer-wrapper.md](../_shared/par-reviewer-wrapper.md) relative to this loaded document and insert that wrapper where marked. Fill in the bracketed values.
