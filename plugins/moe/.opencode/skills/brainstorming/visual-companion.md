...
Resolve [skills/brainstorming/scripts/start-server.sh](scripts/start-server.sh) relative to this
...
Resolve [skills/brainstorming/scripts/stop-server.sh](scripts/stop-server.sh) relative to this
