...
description: Use when starting an iterate run on human spec collateral — reads the spec, produces per-epic requirement files with proof obligations and behavior scenario cards with stable IDs.
---
...
Invoked by `iterate` during bootstrap, or standalone when you need to regenerate requirements from human spec collateral.
...
Resolve [skills/extract-requirements/scripts/chunk_spec.mjs](scripts/chunk_spec.mjs) relative to this loaded document, then invoke it as `node "<resolved-chunk_spec.mjs>" <spec-path>`.
...
Resolve [skills/extract-requirements/scripts/aggregate_stories.mjs](scripts/aggregate_stories.mjs) relative to this loaded document, then invoke it as `node "<resolved-aggregate_stories.mjs>" -o docs/moe/iterations/requirements/ <json-file-1> <json-file-2> ...`.
...
Resolve [skills/extract-requirements/scripts/aggregate_scenarios.mjs](scripts/aggregate_scenarios.mjs) relative to this loaded document, then invoke it as `node "<resolved-aggregate_scenarios.mjs>" -o docs/moe/iterations/behavior-scenarios.md --stories-dir docs/moe/iterations/requirements/ <json-file-1> <json-file-2> ...`.
...
Resolve [skills/extract-requirements/scripts/backlink_scenarios.mjs](scripts/backlink_scenarios.mjs) relative to this loaded document, then invoke it as `node "<resolved-backlink_scenarios.mjs>" docs/moe/iterations/behavior-scenarios.md docs/moe/iterations/requirements/`.
...
Resolve [skills/extract-requirements/scripts/validate_requirements_index.mjs](scripts/validate_requirements_index.mjs)
as `<resolved-validate_requirements_index.mjs>` and
[skills/extract-requirements/scripts/validate_scenarios.mjs](scripts/validate_scenarios.mjs) as
