...
Use this template INSIDE the PAR wrapper when dispatching code-quality reviewers. Resolve [skills/_shared/par-reviewer-wrapper.md](../_shared/par-reviewer-wrapper.md) relative to this loaded document and insert that wrapper where marked. This is Stage 2 of the two-stage review — it runs AFTER spec-compliance review passes.
