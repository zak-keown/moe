...
- Each plan owns a workspace: at skill start, resolve
  [skills/subagent-driven-development/scripts/sdd-workspace.mjs](scripts/sdd-workspace.mjs) relative
...
- **Task brief:** before dispatching an implementer, resolve
  [skills/subagent-driven-development/scripts/task-brief.mjs](scripts/task-brief.mjs) relative to
