...
Use this prompt with a **a deep-reasoning model from the current spawn allowlist** subagent for thorough semantic analysis.
...
5. Dispatch a a deep-reasoning model from the current spawn allowlist subagent with the prompt
