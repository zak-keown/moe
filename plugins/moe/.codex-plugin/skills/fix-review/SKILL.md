...
**REQUIRED BACKGROUND:** You MUST understand `tdd`. This
...
Use `sdd` for the dispatch mechanics. The subagent
...
Resolve [skills/fix-review/scripts/stamp-disposition.mjs](scripts/stamp-disposition.mjs)
...
Resolve [skills/fix-review/scripts/compact-resolved.mjs](scripts/compact-resolved.mjs)
