...
description: "Use when a code-structure question about the code corpus indexed by moedex would benefit from one budgeted, graph-annotated call: where a symbol is, who calls it, or the blast radius of changing it."
mode: subagent
---
