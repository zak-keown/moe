...
| `native-renderers` | Human-run the three renderer-producing skills on macOS and inspect each ladder rung, including the disabled-Artifact fallback | The automated companion and platform suites cannot judge the rendered result |
