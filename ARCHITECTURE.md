...
|---|---|---|
| `@bubstack/moe-core` | Planning, TDD, debugging, review, collaboration, writing, plugin authoring, and architecture skills | generated `moe-core` and `moe-everything` plugins |
