...
- Hardener skill. Repo local, does not install with Moe. Installs a temporary copy of Moe and attempts to break/compromise it. Files backlog items, does not fix.
...
- Add no-no words and patterns to house voice
- Explore a Project Manager module with pluggable backends; build off backlog work but also add a Shortcut integration as an optional non-local backend
